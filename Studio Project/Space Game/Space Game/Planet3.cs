...
namespace Space_Game
{
    public partial class Planet3 : Form
    {
        ...
        bool ReverseAnim, enemy1ReverseAnim, enemy2ReverseAnim, enemy3ReverseAnim, enemy4ReverseAnim, enemyBossReverseAnim, isAPressed, isWPressed, isSPressed, isDPressed;
        ...
        private void Planet3_Load(object sender, EventArgs e)
        {
            ...
            Variables.CurrentForm = "Planet3";
            Variables.OnPlanet = true;
            this.KeyDown += new KeyEventHandler(Planet3_KeyDown);
            this.KeyUp += new KeyEventHandler(Planet3_KeyUp);
            ...
            Variables.PlanetCombatBG = "FormalhautCombatMap";
        }

        private void Planet3_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Planet3_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void timerSpriteAnim_Tick(object obj)
        {
            if (Variables.Pause == false)
            {
                ...
                if (picboxPlayer.Bounds.IntersectsWith(picboxHazard1.Bounds))
                {
                    if (Variables.Pause == false)
                    {
                        Variables.Pause = true;
                ...
                if (picboxPlayer.Bounds.IntersectsWith(picboxFall1.Bounds))
                {
                    Variables.Pause = true;
                ...
                if (picboxPlayer.Bounds.IntersectsWith(picboxTeleport1.Bounds))
                    picboxPlayer.Invoke((MethodInvoker)(() => picboxPlayer.Location = new Point(464, 35)));

                if (picboxPlayer.Bounds.IntersectsWith(picboxTeleport2.Bounds))
                    picboxPlayer.Invoke((MethodInvoker)(() => picboxPlayer.Location = new Point(109, 351)));
                ...
                else if (picboxPlayer.Bounds.IntersectsWith(picboxEnemy1.Bounds))
                {
                    if (picboxEnemy1.Visible == true)
                    {
                        ...
                        Variables.EnemyName = "Formalhaut Grunt";
            ...
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy1.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxEnemy1.Bounds.IntersectsWith(EdgeLeft.Bounds) ||
                        ...
                        picboxEnemy1.Bounds.IntersectsWith(picboxShip.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxFall1.Bounds))
                        picboxEnemy1.Invoke((MethodInvoker)(() => picboxEnemy1.Location = new Point(oldenemy1LocX, oldenemy1LocY)));
                }
            }
        }
            ...
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy2.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxEnemy2.Bounds.IntersectsWith(EdgeLeft.Bounds) ||
                        ...
                        picboxEnemy2.Bounds.IntersectsWith(picboxShip.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxFall1.Bounds))
                        picboxEnemy2.Invoke((MethodInvoker)(() => picboxEnemy2.Location = new Point(oldenemy2LocX, oldenemy2LocY)));
                }
            }
        }
            ...
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy3.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxEnemy3.Bounds.IntersectsWith(EdgeLeft.Bounds) ||
                        ...
                        picboxEnemy3.Bounds.IntersectsWith(picboxShip.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxFall1.Bounds))
                        picboxEnemy3.Invoke((MethodInvoker)(() => picboxEnemy3.Location = new Point(oldenemy3LocX, oldenemy3LocY)));
                }
            }
        }
            ...
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy4.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxEnemy4.Bounds.IntersectsWith(EdgeLeft.Bounds) || 
                        ...
                        picboxEnemy4.Bounds.IntersectsWith(picboxShip.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxFall1.Bounds))
                        picboxEnemy4.Invoke((MethodInvoker)(() => picboxEnemy4.Location = new Point(oldenemy4LocX, oldenemy4LocY)));
                }
            }
        }
            ...
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxBoss.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxBoss.Bounds.IntersectsWith(EdgeLeft.Bounds) || 
                        ...
                        picboxBoss.Bounds.IntersectsWith(picboxShip.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxFall1.Bounds))
                        picboxBoss.Invoke((MethodInvoker)(() => picboxBoss.Location = new Point(oldenemyBossLocX, oldenemyBossLocY)));
                }
            }
        }
        ...
        private void timerFall_Tick(object obj)
        {
            ...
            if (picboxPlayer.Bounds.IntersectsWith(picboxHazard1.Bounds)) //once the player hits the lava
                if (deathFallTick == 3)
                {
