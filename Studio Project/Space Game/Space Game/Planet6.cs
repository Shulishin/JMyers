...
{
    public partial class Planet6 : Form
    {
        System.Threading.Timer timerWalkAnim, timerEnemy1Walk, timerEnemy2Walk, timerEnemy3Walk, timerEnemy4Walk, timerBossWalk, timerFall;

        Point PlayerStartLocation = new Point();

        int deathFallTick, Anim, enemyRndInt,
        ...
        PictureBox[] ActiveHazards = new PictureBox[21], ActiveFalls = new PictureBox[8];
        ...
        private void Planet6_Load(object sender, EventArgs e)
        {
            ...
            timerFall = new System.Threading.Timer(new TimerCallback(timerFall_Tick), null, Timeout.Infinite, Timeout.Infinite);


            Variables.CurrentForm = "Planet6";
            Variables.OnPlanet = true;
            this.KeyDown += new KeyEventHandler(Planet6_KeyDown);
            this.KeyUp += new KeyEventHandler(Planet6_KeyUp);
            ...
            ActiveHazards[3] = picboxHazard4;
            ActiveHazards[4] = picboxHazard5;
            ActiveHazards[5] = picboxHazard6;
            ActiveHazards[6] = picboxHazard7;
            ActiveHazards[7] = picboxHazard8;
            ActiveHazards[8] = picboxHazard9;
            ActiveHazards[9] = picboxHazard10;
            ActiveHazards[10] = picboxHazard11;
            ActiveHazards[11] = picboxHazard12;
            ActiveHazards[12] = picboxHazard13;
            ActiveHazards[13] = picboxHazard14;
            ActiveHazards[14] = picboxHazard15;
            ActiveHazards[15] = picboxHazard16;
            ActiveHazards[16] = picboxHazard17;
            ActiveHazards[17] = picboxHazard18;
            ActiveHazards[18] = picboxHazard19;
            ActiveHazards[19] = picboxHazard20;
            ActiveHazards[20] = picboxHazard21;

            ActiveFalls[0] = picboxFall1;
            ActiveFalls[1] = picboxFall2;
            ActiveFalls[2] = picboxFall3;
            ActiveFalls[3] = picboxFall4;
            ActiveFalls[4] = picboxFall5;
            ActiveFalls[5] = picboxFall6;


            Variables.PlanetCombatBG = "PyxisCombatMap";
        }

        private void Planet6_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Planet6_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void timerSpriteAnim_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    foreach (PictureBox f in ActiveFalls)
                    {
                        if (picboxPlayer.Bounds.IntersectsWith(f.Bounds))
                        {
                            Variables.Pause = true;
                            timerFall.Change(150, 150);
                            deathFallTick = 0;

                        }
                    }

                    if (picboxPlayer.Bounds.IntersectsWith(picboxTeleport1.Bounds))
                        picboxPlayer.Invoke((MethodInvoker)(() => picboxPlayer.Location = new Point(452, 284)));

                    if (picboxPlayer.Bounds.IntersectsWith(picboxTeleport2.Bounds))
                        picboxPlayer.Invoke((MethodInvoker)(() => picboxPlayer.Location = new Point(250, 176)));

                    if (picboxPlayer.Bounds.IntersectsWith(picboxTeleport3.Bounds))
                        picboxPlayer.Invoke((MethodInvoker)(() => picboxPlayer.Location = new Point(67, 303)));

                    if (picboxPlayer.Bounds.IntersectsWith(picboxTeleport4.Bounds))
                        picboxPlayer.Invoke((MethodInvoker)(() => picboxPlayer.Location = new Point(451, 144)));

                    if (picboxPlayer.Bounds.IntersectsWith(picboxTeleport5.Bounds))
                        picboxPlayer.Invoke((MethodInvoker)(() => picboxPlayer.Location = new Point(323, 16)));

                    if (picboxPlayer.Bounds.IntersectsWith(picboxTeleport6.Bounds))
                        picboxPlayer.Invoke((MethodInvoker)(() => picboxPlayer.Location = new Point(65, 106)));

                    if (picboxPlayer.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxPlayer.Bounds.IntersectsWith(EdgeTop.Bounds) || picboxPlayer.Bounds.IntersectsWith(EdgeRight.Bounds) || picboxPlayer.Bounds.IntersectsWith(EdgeLeft.Bounds))
                    {
                    ...
                    else if (picboxPlayer.Bounds.IntersectsWith(picboxEnemy1.Bounds))
                    {
                        if (picboxEnemy1.Visible == true)
                        {
                            ...
                            Variables.EnemyName = "Pyxis Grunt";
                            Variables.EnemyHP = 600;
                    ...
                    else if (picboxPlayer.Bounds.IntersectsWith(picboxBoss.Bounds))
                    {
                        if (picboxBoss.Visible == true)
                        {
                            ...
                            Variables.EnemyName = "Dakhan";
                            Variables.EnemyHP = 600;
                            Variables.EnemyDamage = 60;
        ...
        private void timerEnemy1Walk_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    foreach (PictureBox f in ActiveFalls)
                    {
                        if (picboxEnemy4.Bounds.IntersectsWith(f.Bounds))
                        {
                            picboxEnemy4.Invoke((MethodInvoker)(() => picboxEnemy4.Location = new Point(oldenemy4LocX, oldenemy4LocY)));
                        }
                    }
                    
                    if (picboxEnemy1.Bounds.IntersectsWith(picboxTeleport1.Bounds))
                        picboxEnemy1.Invoke((MethodInvoker)(() => picboxEnemy1.Location = new Point(452, 284)));

                    if (picboxEnemy1.Bounds.IntersectsWith(picboxTeleport2.Bounds))
                        picboxEnemy1.Invoke((MethodInvoker)(() => picboxEnemy1.Location = new Point(250, 176)));

                    if (picboxEnemy1.Bounds.IntersectsWith(picboxTeleport3.Bounds))
                        picboxEnemy1.Invoke((MethodInvoker)(() => picboxEnemy1.Location = new Point(67, 303)));

                    if (picboxEnemy1.Bounds.IntersectsWith(picboxTeleport4.Bounds))
                        picboxEnemy1.Invoke((MethodInvoker)(() => picboxEnemy1.Location = new Point(451, 144)));

                    if (picboxEnemy1.Bounds.IntersectsWith(picboxTeleport5.Bounds))
                        picboxEnemy1.Invoke((MethodInvoker)(() => picboxEnemy1.Location = new Point(323, 16)));

                    if (picboxEnemy1.Bounds.IntersectsWith(picboxTeleport6.Bounds))
                        picboxEnemy1.Invoke((MethodInvoker)(() => picboxEnemy1.Location = new Point(65, 106)));
        ...
        private void timerEnemy2Walk_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy2.Bounds.IntersectsWith(picboxTeleport1.Bounds))
                        picboxEnemy2.Invoke((MethodInvoker)(() => picboxEnemy2.Location = new Point(452, 284)));

                    if (picboxEnemy2.Bounds.IntersectsWith(picboxTeleport2.Bounds))
                        picboxEnemy2.Invoke((MethodInvoker)(() => picboxEnemy2.Location = new Point(250, 176)));

                    if (picboxEnemy2.Bounds.IntersectsWith(picboxTeleport3.Bounds))
                        picboxEnemy2.Invoke((MethodInvoker)(() => picboxEnemy2.Location = new Point(67, 303)));

                    if (picboxEnemy2.Bounds.IntersectsWith(picboxTeleport4.Bounds))
                        picboxEnemy2.Invoke((MethodInvoker)(() => picboxEnemy2.Location = new Point(451, 144)));

                    if (picboxEnemy2.Bounds.IntersectsWith(picboxTeleport5.Bounds))
                        picboxEnemy2.Invoke((MethodInvoker)(() => picboxEnemy2.Location = new Point(323, 16)));

                    if (picboxEnemy2.Bounds.IntersectsWith(picboxTeleport6.Bounds))
                        picboxEnemy2.Invoke((MethodInvoker)(() => picboxEnemy2.Location = new Point(65, 106)));
        ...
        private void timerEnemy3Walk_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy3.Bounds.IntersectsWith(picboxTeleport1.Bounds))
                        picboxEnemy3.Invoke((MethodInvoker)(() => picboxEnemy3.Location = new Point(452, 284)));

                    if (picboxEnemy3.Bounds.IntersectsWith(picboxTeleport2.Bounds))
                        picboxEnemy3.Invoke((MethodInvoker)(() => picboxEnemy3.Location = new Point(250, 176)));

                    if (picboxEnemy3.Bounds.IntersectsWith(picboxTeleport3.Bounds))
                        picboxEnemy3.Invoke((MethodInvoker)(() => picboxEnemy3.Location = new Point(67, 303)));

                    if (picboxEnemy3.Bounds.IntersectsWith(picboxTeleport4.Bounds))
                        picboxEnemy3.Invoke((MethodInvoker)(() => picboxEnemy3.Location = new Point(451, 144)));

                    if (picboxEnemy3.Bounds.IntersectsWith(picboxTeleport5.Bounds))
                        picboxEnemy3.Invoke((MethodInvoker)(() => picboxEnemy3.Location = new Point(323, 16)));

                    if (picboxEnemy3.Bounds.IntersectsWith(picboxTeleport6.Bounds))
                        picboxEnemy3.Invoke((MethodInvoker)(() => picboxEnemy3.Location = new Point(65, 106)));
        ...
        private void timerEnemy4Walk_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy4.Bounds.IntersectsWith(picboxTeleport1.Bounds))
                        picboxEnemy4.Invoke((MethodInvoker)(() => picboxEnemy4.Location = new Point(452, 284)));

                    if (picboxEnemy4.Bounds.IntersectsWith(picboxTeleport2.Bounds))
                        picboxEnemy4.Invoke((MethodInvoker)(() => picboxEnemy4.Location = new Point(250, 176)));

                    if (picboxEnemy4.Bounds.IntersectsWith(picboxTeleport3.Bounds))
                        picboxEnemy4.Invoke((MethodInvoker)(() => picboxEnemy4.Location = new Point(67, 303)));

                    if (picboxEnemy4.Bounds.IntersectsWith(picboxTeleport4.Bounds))
                        picboxEnemy4.Invoke((MethodInvoker)(() => picboxEnemy4.Location = new Point(451, 144)));

                    if (picboxEnemy4.Bounds.IntersectsWith(picboxTeleport5.Bounds))
                        picboxEnemy4.Invoke((MethodInvoker)(() => picboxEnemy4.Location = new Point(323, 16)));

                    if (picboxEnemy4.Bounds.IntersectsWith(picboxTeleport6.Bounds))
                        picboxEnemy4.Invoke((MethodInvoker)(() => picboxEnemy4.Location = new Point(65, 106)));
            ...
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxBoss.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxBoss.Bounds.IntersectsWith(EdgeLeft.Bounds) || 
                        ...
                        picboxBoss.Bounds.IntersectsWith(picboxShip.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxTeleport6.Bounds) || 
                        picboxBoss.Bounds.IntersectsWith(picboxFall6.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxFall7.Bounds) ||
                        picboxBoss.Bounds.IntersectsWith(picboxFall8.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxHazard15.Bounds))
                        picboxBoss.Invoke((MethodInvoker)(() => picboxBoss.Location = new Point(oldenemyBossLocX, oldenemyBossLocY)));
                }
            }
        }
        ...
        private void timerFall_Tick(object obj)
        {
            picboxPlayer.Invoke((MethodInvoker)(() => picboxPlayer.Location = new Point(picboxPlayer.Location.X, picboxPlayer.Location.Y + 3))); //set location, moving downwards

            foreach (PictureBox i in ActiveHazards)
            {
                if (picboxPlayer.Bounds.IntersectsWith(i.Bounds)) //once the player hits the lava/whatever else
                    if (deathFallTick == 3)
                    {
                        //disposing all, launching game over form
                        this.Invoke((MethodInvoker)(() =>
                        {
                            timerFall.Dispose();
                            timerWalkAnim.Dispose();
