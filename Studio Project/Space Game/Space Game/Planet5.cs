...
namespace Space_Game
{
    public partial class Planet5 : Form
    {
        ...
        PictureBox[] ActiveImpassables = new PictureBox[9];
        ...
        private void Planet5_Load(object sender, EventArgs e)
        {
            ...
            Variables.CurrentForm = "Planet5";
            Variables.OnPlanet = true;
            this.KeyDown += new KeyEventHandler(Planet5_KeyDown);
            this.KeyUp += new KeyEventHandler(Planet5_KeyUp);
            ...
            Variables.PlanetCombatBG = "CetusCombatMap";
        }

        private void Planet5_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Planet5_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void timerSpriteAnim_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    {
                        picboxHazard1.Image = Resources.CetusWaterCrack;
                        picboxHazard1.Show();
                        Variables.Pause = true;
                    ...
                    if (picboxPlayer.Bounds.IntersectsWith(picboxHazard2.Bounds))
                    {
                        picboxHazard2.Image = Resources.CetusWaterCrack;
                        picboxHazard2.Show();
                        Variables.Pause = true;
                        timerFall.Change(150, 150);
                        deathFallTick = 0;
                    ...
                    if (picboxPlayer.Bounds.IntersectsWith(picboxSecret1.Bounds))
                    {
                        if (Secret1Found == false)
                        {
                            isAPressed = false;
                            isWPressed = false;
                            isSPressed = false;
                            isDPressed = false;
                            Variables.ItemFound = "Secret";
                    ...
                    else if (picboxPlayer.Bounds.IntersectsWith(picboxEnemy1.Bounds))
                    {
                        if (picboxEnemy1.Visible == true)
                        {
                            ...
                            Variables.EnemyName = "Cetus Grunt";
                    ...
                    else if (picboxPlayer.Bounds.IntersectsWith(picboxBoss.Bounds))
                    {
                        if (picboxBoss.Visible == true)
                        {
                            ...
                            Form CustomMessageBox = new CustomMessageBox();
                            Variables.MessageBoxOutput = "Boss5";
                            CustomMessageBox.ShowDialog();
