...
namespace Space_Game
{
    public partial class Planet1 : Form
    {
        ...
        PictureBox[] ActiveImpassables = new PictureBox[4];
        ...
        private void Planet1_Load(object sender, EventArgs e)
        {
            ...
            Variables.CurrentForm = "Planet1";
            Variables.OnPlanet = true;
            this.KeyDown += new KeyEventHandler(Planet1_KeyDown);
            this.KeyUp += new KeyEventHandler(Planet1_KeyUp);
            ...
            Variables.PlanetCombatBG = "AlphaCenturiCombatMap";
        }

        private void Planet1_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Planet1_KeyUp(object sender, KeyEventArgs e)
        {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxPlayer.Bounds.IntersectsWith(picboxSpecial1.Bounds))
                    {
                        if (Item1Found == false)
                        {
                            ...
                            isSPressed = false;
                            isDPressed = false;
                            Variables.ItemFound = "Health";
                            Variables.PlayerHP += 15;
                            Variables.Pause = true;
                    ...
                    if (picboxPlayer.Bounds.IntersectsWith(picboxSpecial2.Bounds))
                    {
                        if (Item2Found == false)
                        {
                            isAPressed = false;
                    ...
                    else if (picboxPlayer.Bounds.IntersectsWith(picboxEnemy1.Bounds))
                    {
                        if (picboxEnemy1.Visible == true)
                        {
                            ...
                            Variables.EnemyName = "Enemy1";
                            Variables.EnemyHP = 100;
                            Variables.EnemyDamage = 2;

                            //    Variables.EnemyName = "Enemy1";
                            //    Variables.EnemyHP = 200;
                            //    Variables.EnemyDamage = 4;
                            //}
                            //else if (Variables.Stage == 3)
                            //{
                            //    Variables.EnemyName = "Enemy1";
                            //    Variables.EnemyHP = 300;
                            //    Variables.EnemyDamage = 6;
                            //}
                            ...
                            //{
                            //    Variables.EnemyName = "Enemy1";
                            //    Variables.EnemyHP = 500;
                            //    Variables.EnemyDamage = 10;
                            //}
                            ...
                            //{
                            //    Variables.EnemyName = "Enemy1";
                            //    Variables.EnemyHP = 700;
                            //    Variables.EnemyDamage = 14;
                            //}
                    ...
                    else if (picboxPlayer.Bounds.IntersectsWith(picboxEnemy2.Bounds))
                    {
                        if (picboxEnemy2.Visible == true)
                        {
                            ...
                            Variables.EnemyName = "Enemy2";
                            Variables.EnemyHP = 100;
                            Variables.EnemyDamage = 3;
                    ...
                    else if (picboxPlayer.Bounds.IntersectsWith(picboxBoss.Bounds))
                    {
                        if (picboxBoss.Visible == true)
                        {
                            ...
                            Variables.EnemyName = "Minos";
                            Variables.EnemyHP = 500;
                            Variables.EnemyDamage = 10;

                            //else if (Variables.Stage == 2)
                            //{
                            //    Variables.EnemyName = "Relok";
                            //    Variables.EnemyHP = 200;
                            //    Variables.EnemyDamage = 20;
                            //}
                            //else if (Variables.Stage == 3)
                            //{
                            //    Variables.EnemyName = "Yu'ku";
                            //    Variables.EnemyHP = 300;
                            //    Variables.EnemyDamage = 30;
                            //}
                            //else if (Variables.Stage == 4)
                            ...
                            //else if (Variables.Stage == 5)
                            //{
                            //    Variables.EnemyName = "Zix";
                            //    Variables.EnemyHP = 500;
                            //    Variables.EnemyDamage = 50;
                            //}
                            //else if (Variables.Stage == 6)
                            //{
                            //    Variables.EnemyName = "Gorkon";
                            //    Variables.EnemyHP = 600;
        ...
        private void timerEnemy1Walk_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy1.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxEnemy1.Bounds.IntersectsWith(EdgeLeft.Bounds) || picboxEnemy1.Bounds.IntersectsWith(EdgeRight.Bounds) || picboxEnemy1.Bounds.IntersectsWith(EdgeTop.Bounds) || picboxEnemy1.Bounds.IntersectsWith(picboxEnemy2.Bounds) || picboxEnemy1.Bounds.IntersectsWith(picboxEnemy3.Bounds) || picboxEnemy1.Bounds.IntersectsWith(picboxEnemy4.Bounds) || picboxEnemy1.Bounds.IntersectsWith(picboxBoss.Bounds) || picboxEnemy1.Bounds.IntersectsWith(picboxShip.Bounds))
                        picboxEnemy1.Invoke((MethodInvoker)(() => picboxEnemy1.Location = new Point(oldenemy1LocX, oldenemy1LocY)));
                }
            }
        }
        ...
        private void timerEnemy2Walk_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy2.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxEnemy2.Bounds.IntersectsWith(EdgeLeft.Bounds) || picboxEnemy2.Bounds.IntersectsWith(EdgeRight.Bounds) || picboxEnemy2.Bounds.IntersectsWith(EdgeTop.Bounds) || picboxEnemy2.Bounds.IntersectsWith(picboxEnemy1.Bounds) || picboxEnemy2.Bounds.IntersectsWith(picboxEnemy3.Bounds) || picboxEnemy2.Bounds.IntersectsWith(picboxEnemy4.Bounds) || picboxEnemy2.Bounds.IntersectsWith(picboxBoss.Bounds) || picboxEnemy2.Bounds.IntersectsWith(picboxShip.Bounds))
                        picboxEnemy2.Invoke((MethodInvoker)(() => picboxEnemy2.Location = new Point(oldenemy2LocX, oldenemy2LocY)));
                }
            }
        }
        ...
        private void timerEnemy3Walk_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy3.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxEnemy3.Bounds.IntersectsWith(EdgeLeft.Bounds) || picboxEnemy3.Bounds.IntersectsWith(EdgeRight.Bounds) || picboxEnemy3.Bounds.IntersectsWith(EdgeTop.Bounds) || picboxEnemy3.Bounds.IntersectsWith(picboxEnemy1.Bounds) || picboxEnemy3.Bounds.IntersectsWith(picboxEnemy2.Bounds) || picboxEnemy3.Bounds.IntersectsWith(picboxEnemy4.Bounds) || picboxEnemy3.Bounds.IntersectsWith(picboxBoss.Bounds) || picboxEnemy3.Bounds.IntersectsWith(picboxShip.Bounds))
                        picboxEnemy3.Invoke((MethodInvoker)(() => picboxEnemy3.Location = new Point(oldenemy3LocX, oldenemy3LocY)));
                }
            }
        }
        ...
        private void timerEnemy4Walk_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxEnemy4.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxEnemy4.Bounds.IntersectsWith(EdgeLeft.Bounds) || picboxEnemy4.Bounds.IntersectsWith(EdgeRight.Bounds) || picboxEnemy4.Bounds.IntersectsWith(EdgeTop.Bounds) || picboxEnemy4.Bounds.IntersectsWith(picboxEnemy1.Bounds) || picboxEnemy4.Bounds.IntersectsWith(picboxEnemy2.Bounds) || picboxEnemy4.Bounds.IntersectsWith(picboxEnemy3.Bounds) || picboxEnemy4.Bounds.IntersectsWith(picboxBoss.Bounds) || picboxEnemy4.Bounds.IntersectsWith(picboxShip.Bounds))
                        picboxEnemy4.Invoke((MethodInvoker)(() => picboxEnemy4.Location = new Point(oldenemy4LocX, oldenemy4LocY)));
                }
            }
        }
        ...
        private void timerBossWalk_Tick(object obj)
        {
            if (this.Visible == true)
            {
                ...
                if (Variables.Pause == false)
                {
                    ...
                    if (picboxBoss.Bounds.IntersectsWith(EdgeBottom.Bounds) || picboxBoss.Bounds.IntersectsWith(EdgeLeft.Bounds) || picboxBoss.Bounds.IntersectsWith(EdgeRight.Bounds) || picboxBoss.Bounds.IntersectsWith(EdgeTop.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxEnemy1.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxEnemy2.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxEnemy3.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxEnemy4.Bounds) || picboxBoss.Bounds.IntersectsWith(picboxShip.Bounds))
                        picboxBoss.Invoke((MethodInvoker)(() => picboxBoss.Location = new Point(oldenemyBossLocX, oldenemyBossLocY)));
                }
            }
        }
